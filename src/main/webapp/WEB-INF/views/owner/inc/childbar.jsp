...
<div class="childbar">
	...
	<div class="itembar">
		<a class="bar-item" href="/client/owner/inventory/item/list">상품목록</a>
		<a class="bar-item" href="/client/owner/inventory/category/list">카테고리 목록</a>
		<a class="bar-item" href="javascript:alert('서비스 준비 중입니다')">할인 목록</a>
	</div>
</div>